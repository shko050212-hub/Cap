  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(circle at center, transparent 35%, rgba(0,0,0,0.6) 75%, rgba(0,0,0,0.85) 100%)'
        }}
      />
      ...
      >
        <div className="relative w-full h-full border border-gray-800 bg-gray-900 overflow-hidden">
